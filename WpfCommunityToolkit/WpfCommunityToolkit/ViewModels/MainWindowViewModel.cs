...
public partial class MainWindowViewModel : ObservableRecipient //ObservableObject, IRecipient<ArtistChangedMessage>
{
    ...
    public MainWindowViewModel(ChinookContext context, ILogger<MainWindowViewModel> logger)
    {
        this.context = context;
        // this.messenger = messenger;
        this.logger = logger;
        // Message registrieren für ArtistChanged
        this.Messenger.Register<MainWindowViewModel, ArtistChangedMessage>(this, (r, m) => r.Receive(m));
    ...
    {
        // Code zum Entfernen eines Artist
    }
    ...
    private void EditArtist()
    {
        ...
        this.Messenger.Send(new ShowArtistEditDialogMessage(this.SelectedArtist));
    }
